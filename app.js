...
app.post(`/api/v1/synchronizer/data`, wrap(async (req, res) => {
    ...
    if (requestedType == `period`){
        ...
        let s = DateTime.fromFormat(start, 'yyyy/MM/dd').setZone(timezone, {keepLocalTime:true});
        //let e = DateTime.local(yearRange[1],12/31,{zone:timezone});
        let e = DateTime.fromFormat(end, 'yyyy/MM/dd').setZone(timezone, {keepLocalTime:true});
